...
{
    private readonly SdfTopographyFieldEvaluator fieldEvaluator = new();
    private readonly SdfObstacleInteractionController interactionController = new();
    ...
    private void OnRenderObject()
    {
        ...
        ScalarFieldGridBuilder.Build(
            ...
            (x, y) => fieldEvaluator.Evaluate(x, y, elapsedTime, obstacles));
